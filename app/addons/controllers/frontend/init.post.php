...
if ($dev_tools['dev_enable'] == 'Y' && $dev_tools['dev_notification'] == 'Y' && !empty($dev_tools['dev_notification_str'])) {
	fn_set_notification('E', __('notice'), $dev_tools['dev_notification_str']);
}